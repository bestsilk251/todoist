...
const styles = StyleSheet.create({
  ...
  sheet: { width: '100%', maxWidth: 560, alignSelf: 'center', backgroundColor: palette.surface, borderTopLeftRadius: 26, borderTopRightRadius: 26, borderWidth: 1, borderBottomWidth: 0, borderColor: palette.borderStrong, overflow: 'hidden', shadowColor: '#000', shadowOpacity: 0.3, shadowRadius: 24, shadowOffset: { width: 0, height: -10 }, elevation: 24 },
  ...
  illustrationCard: { width: 78, height: 88, borderRadius: 20, alignItems: 'center', justifyContent: 'center', backgroundColor: palette.chip, borderWidth: 1, borderColor: palette.borderStrong, transform: [{ rotate: '8deg' }], shadowColor: palette.accent, shadowOpacity: 0.2, shadowRadius: 14, shadowOffset: { width: 0, height: 8 } },
  welcomeIllustration: { gap: 8 },
  welcomeCheck: { position: 'absolute', top: 12, right: 10 },
  floatingPlus: { position: 'absolute', right: 2, bottom: 5, width: 34, height: 34, borderRadius: 11, alignItems: 'center', justifyContent: 'center', backgroundColor: palette.accent, borderWidth: 2, borderColor: palette.surface },
  ...
  floatingMic: { position: 'absolute', right: 0, bottom: 2, width: 38, height: 38, borderRadius: 19, alignItems: 'center', justifyContent: 'center', backgroundColor: palette.surfaceAlt, borderWidth: 1, borderColor: palette.accent },
